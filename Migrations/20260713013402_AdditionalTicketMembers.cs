...
{
    /// <inheritdoc />
    public partial class AdditionalTicketMembers : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MembershipRole = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectMembers_AspNetUsers_AddedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketHistories_TicketId_CreatedAtUtc",
                table: "TicketHistories",
                columns: new[] { "TicketId", "CreatedAtUtc" });
        }
